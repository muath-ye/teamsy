                    ...
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ route('home') }}"
                                ...
                                :class="{
                                    'bg-indigo-500': isOpen === '{{ route('home') }}',
                                    'text-white': isOpen ===
                                        '{{ route('home') }}',
                                    'text-gray-700': isOpen !== '{{ route('home') }}'
                                }">
                            ...
                            <a href="{{ route('users') }}"
                                class="text-sm font-medium  py-2 px-2 hover:bg-indigo-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
                                :class="{
                                    'bg-indigo-500': isOpen === '{{ route('users') }}',
                                    'text-white': isOpen ===
                                        '{{ route('users') }}',
                                    'text-gray-700': isOpen !== '{{ route('users') }}'
                                }">
                                <svg class="w-6 h-6 fill-current inline-block" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <a href="{{ route('company') }}"
                                class="text-sm font-medium  py-2 px-2 hover:bg-indigo-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
                                :class="{
                                    'bg-indigo-500': isOpen === '{{ route('company') }}',
                                    'text-white': isOpen ===
                                        '{{ route('company') }}',
